...
(function() {
  var Scene, Style, Tile, TileGroup, Vec2, Vec3;
  ...
  TileGroup = (function() {
    ...
    TileGroup.prototype.sin = function(x, a, w, b) {
      ...
      return this.match(function(i, len) {
        ...
        return (a + b + a * Math.sin(theta * w + x)) * p;
      });
    };
  ...
  Scene = (function() {
    ...
    Scene.prototype.render = function() {
      var p, projs, tile, _i, _j, _len, _len1, _ref, _ref1, _results;

      this.ctx.clearRect(-this.w, -this.h, this.w * 2, this.h * 2);
      _ref = this.tilegroup.tiles;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        tile = _ref[_i];
  ...
  (function() {
    ...
    scene.enterFrame(function() {
      this.roty += (Math.PI / 128) % (Math.PI * 4);
      return scene.tilegroup.sin(this.roty * 2, 80);
    });
